...
>
> To add a real dashboard, run **`/add-dashboard`** (**Cursor**) or follow your harness (**Claude Code** — [`harness/`](../../harness/)):
>
> ```
...
Daily extract: Datadog MCP + `scripts/datadog_dashboard_extract.py` — see
